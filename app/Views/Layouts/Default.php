        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= PROOT?>" class="app-brand-link">
              <span class="app-brand-text demo menu-text fw-bolder ms-2"><img src="<?= PROOT?>assets/img/logo.jpg" width="200px"  alt=""></span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="<?= PROOT?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Upload</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="viewvote.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
                <div data-i18n="Analytics">View table</div>
              </a>
            </li>
            <!-- <li class="menu-item">
              <a href="addcandidate.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-edit"></i>
                <div data-i18n="Analytics">Add candidate</div>
              </a>
            </li> -->
    ...
    <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://ifeanyiizuegbu.com" target="_blank" class="footer-link fw-bolder">Ifeanyi Izuegbu</a>
                </div>
                <div>
                  <a href="#" class="footer-link me-4" target="_blank">Assignment</a>
